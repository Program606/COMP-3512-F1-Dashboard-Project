            ...
            fetch(`https://www.randyconnolly.com/funwebdev/3rd/api/f1/races.php?season=${year}`)
                ...
                .then(data=>{
                    ...
                    races.forEach(raceId=>{
                        fetch(`http://www.randyconnolly.com/funwebdev/3rd/api/f1/qualifying.php?race=${raceId.id}`)
                            .then(resp => resp.json())
                            .then(data => {
                    ...
                    races.forEach(raceId=>{
                        fetch(`http://www.randyconnolly.com/funwebdev/3rd/api/f1/results.php?race=${raceId.id}`)
                            .then(resp => resp.json())
                            .then(data => {
